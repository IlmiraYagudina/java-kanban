...
public class Main {
    ...
    public static void main(String[] args) throws ManagerSaveException {
        ...
        try {
            ...
            Task task1 = new Task("Проект 1", "Интерьер", TaskStatus.NEW, Instant.now(), 1);
            httpTaskManager.createTask(task1);

            Epic epic1 = new Epic("Посадить дерево", "Садоводство", TaskStatus.NEW, Instant.now(), 2);
            httpTaskManager.createEpic(epic1);

            Subtask subtask1 = new Subtask("Уборка", "Домашние дела", TaskStatus.NEW, epic1.getId(), Instant.now(), 3);
