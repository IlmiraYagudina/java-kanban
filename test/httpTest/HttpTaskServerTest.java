...
class HttpTaskServerTest {
    ...
    void shouldGetEpics() {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(url).POST(HttpRequest.BodyPublishers.ofString(gson.toJson(epic))).build();
    ...
    void shouldGetSubtasksTest() {
        ...
        try {
            ...
            if (postResponse.statusCode() == 201) {
                ...
                request = HttpRequest.newBuilder().uri(url).POST(HttpRequest.BodyPublishers.ofString(gson.toJson(subtask))).build();
